...
-- Store Procedures on the table Users
...
INSERT INTO [dbo].[Users]
    (Name, Email, Genre, RG, CPF, MotherName, Status, CreatedAt)
VALUES
    (@name, @email, @genre, @rg, @cpf, @motherName, @status, @createdAt);
...
INSERT INTO [dbo].[Address]
    (UserId, AddressName, Zipcode, State, City, Neighborhood, Street, Number, Complement)
VALUES
...
INSERT INTO [dbo].[UsersDepartments]
    (UserId, DepartmentId)
VALUES
    (1, 1),
    (1, 2),
